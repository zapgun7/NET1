...
class CreateAccountWebFailure final :
 ...
 public:
  ...
  // optional .auth.CreateAccountWebFailure.reason type = 2 [default = INTERNAL_SERVER_ERROR];
  bool has_type() const;
  private:
  bool _internal_has_type() const;
  public:
  void clear_type();
  ::auth::CreateAccountWebFailure_reason type() const;
  void set_type(::auth::CreateAccountWebFailure_reason value);
  private:
  ::auth::CreateAccountWebFailure_reason _internal_type() const;
  void _internal_set_type(::auth::CreateAccountWebFailure_reason value);
  public:
...
class AuthenticateWebFailure final :
 ...
 public:
  ...
  // optional .auth.AuthenticateWebFailure.reason type = 2 [default = INTERNAL_SERVER_ERROR];
  bool has_type() const;
  private:
  bool _internal_has_type() const;
  public:
  void clear_type();
  ::auth::AuthenticateWebFailure_reason type() const;
  void set_type(::auth::AuthenticateWebFailure_reason value);
  private:
  ::auth::AuthenticateWebFailure_reason _internal_type() const;
  void _internal_set_type(::auth::AuthenticateWebFailure_reason value);
  public:
...
// optional .auth.CreateAccountWebFailure.reason type = 2 [default = INTERNAL_SERVER_ERROR];
inline bool CreateAccountWebFailure::_internal_has_type() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CreateAccountWebFailure::has_type() const {
  return _internal_has_type();
}
inline void CreateAccountWebFailure::clear_type() {
  type_ = 2;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::auth::CreateAccountWebFailure_reason CreateAccountWebFailure::_internal_type() const {
  return static_cast< ::auth::CreateAccountWebFailure_reason >(type_);
}
inline ::auth::CreateAccountWebFailure_reason CreateAccountWebFailure::type() const {
  // @@protoc_insertion_point(field_get:auth.CreateAccountWebFailure.type)
  return _internal_type();
}
inline void CreateAccountWebFailure::_internal_set_type(::auth::CreateAccountWebFailure_reason value) {
  assert(::auth::CreateAccountWebFailure_reason_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  type_ = value;
}
inline void CreateAccountWebFailure::set_type(::auth::CreateAccountWebFailure_reason value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:auth.CreateAccountWebFailure.type)
}
...
// optional .auth.AuthenticateWebFailure.reason type = 2 [default = INTERNAL_SERVER_ERROR];
inline bool AuthenticateWebFailure::_internal_has_type() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool AuthenticateWebFailure::has_type() const {
  return _internal_has_type();
}
inline void AuthenticateWebFailure::clear_type() {
  type_ = 1;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::auth::AuthenticateWebFailure_reason AuthenticateWebFailure::_internal_type() const {
  return static_cast< ::auth::AuthenticateWebFailure_reason >(type_);
}
inline ::auth::AuthenticateWebFailure_reason AuthenticateWebFailure::type() const {
  // @@protoc_insertion_point(field_get:auth.AuthenticateWebFailure.type)
  return _internal_type();
}
inline void AuthenticateWebFailure::_internal_set_type(::auth::AuthenticateWebFailure_reason value) {
  assert(::auth::AuthenticateWebFailure_reason_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  type_ = value;
}
inline void AuthenticateWebFailure::set_type(::auth::AuthenticateWebFailure_reason value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:auth.AuthenticateWebFailure.type)
}
